...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=2fe477d4bb84e836499e2e6f9871e1f6&language=en-US&append_to_response=casts,videos,images,releases`, function (movie) {
    ...
    document.title = `${title} - THiNK FILMS`
    ...
    fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=2fe477d4bb84e836499e2e6f9871e1f6&page=1`, addSuggestionMovies)
...
const addSuggestionMovies = function ({
    results: movieList
}, title) {
